  ...
  return (
    <div className="min-h-[700px] lg:h-[84vh] flex flex-col">
      ...
      <div className="relative flex-1 flex flex-col lg:flex-row">
        ...
        <BgGradient 
          className="absolute -bottom-40 left-1/2 transform -translate-x-1/2 w-1/3 h-1/2 lg:bottom-20 lg:left-0 lg:transform-none lg:translate-x-0 lg:w-1/3 lg:h-1/3"
          color="purple"
          ...
          <div className="flex flex-col gap-4 lg:gap-6 w-full items-center lg:items-start">
            ...
            >
              <ContactButton
                ...
                className="w-full h-12 sm:h-auto text-base sm:text-xl lg:text-2xl"
              />
            </div>
          </div>
        </motion.div>
